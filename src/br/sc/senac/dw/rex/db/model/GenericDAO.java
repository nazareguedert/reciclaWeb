...
public abstract class GenericDAO<O extends Object, Z extends Object> implements BaseDAO<O, Z, Long, String> {
	...
	public String sqlDelete() {
		...
		String sql = "UPDATE " + this.banco + "." + tabela + " SET " + this.fim + " = NOW() " + " WHERE " + this.banco
				+ "." + this.tabela + "." + this.fim + " IS NULL" + " AND " + this.banco + "." + this.tabela + "." + id
				+ " = ?";
	...
	public String sqlDelete(Field... f) {
		String sql = "UPDATE " + this.banco + "." + tabela + " SET " + this.fim + " = NOW() " + " WHERE " + this.banco
				+ "." + this.tabela + "." + this.fim + " IS NULL" + " AND " + this.banco + "." + this.tabela + "."
				+ f[0] + " = ?";
	...
	public String sqlSelectTodos() {
		...
		if (!(fs[fs.length - 1].getName().equals("data_remocao"))) {
			return "SELECT * FROM " + this.banco + "." + this.tabela + " ";

		} else {
			return "SELECT * FROM " + this.banco + "." + this.tabela + " WHERE " + this.banco + "." + this.tabela + "."
					+ this.fim + " IS NULL ";
		}
	}

	public String sqlSelectTodos(Long fk) {
		return this.sqlSelectTodos() + " AND " + this.banco + "." + this.tabela + "." + this.keyF + " = " + fk + " ";
	...
	public List<Z> listarTodos(Long fk) {
		...
		if (this.keyF == null) {
			...
			sql = "SELECT * FROM " + this.banco + "." + this.tabela + " WHERE " + this.banco + "." + this.tabela + "."
					+ this.fim + " IS NULL " + " AND " + this.banco + "." + this.tabela + "." + this.keyF + " = " + fk;
		}
	...
	public List<Z> listarTodos(Long fk, Long fk2) {
		...
		if (this.keyF == null) {
			...
			sql = "SELECT * FROM " + this.banco + "." + this.tabela + " WHERE " + this.banco + "." + this.tabela + "."
					+ this.fim + " IS NULL " + " AND " + this.banco + "." + this.tabela + "." + this.keyF + " = " + fk
					+ " " + " AND " + this.banco + "." + this.tabela + "." + this.key2 + " = " + fk2 + " ";
		}
	...
	public List<Z> listarTodos(Boolean estado) {
		...
		String sql = "SELECT * FROM " + this.banco + "." + this.tabela + " WHERE " + this.banco + "." + this.tabela
				+ "." + this.fim + " ";
	...
	// + " WHERE " + this.banco + "." + this.tabela + "." + "dtEntrada" + " BETWEEN
	// ? AND ?";
	//
	// try (PreparedStatement stmt = con.prepareStatement(sql)) {
	//
	...
	public List<Z> listarAoNomeParcial(String... key) {
		...
		String sql = "SELECT * FROM " + this.banco + "." + this.tabela + " WHERE " + this.banco + "." + this.tabela
				+ "." + this.fim + " IS NULL" + " AND LOWER(" + this.banco + "." + this.tabela + "." + this.key
				+ ") LIKE ?";
	...
	public Z get(String... key) {
		...
		String sql = this.sqlSelectTodos() + " AND LOWER(" + this.banco + "." + this.tabela + "." + this.key + ") = ? ";
	...
	public Long getId(String... key) {
		...
		String sql = "SELECT " + this.banco + "." + this.tabela + "." + "id" + " FROM " + this.banco + "." + this.tabela
				+ " WHERE ";
	...
	public Z getPorId(Long id) {
		...
		if (!atributos[atributos.length - 1].getName().equals("data_remocao")) {
			sql += " WHERE ";
		} else {
			sql += " AND ";
		}
	...
	public Boolean existente(String... key) {
		...
		String sql = "SELECT " + "IF((" + "SELECT " + "MIN(" + this.banco + "." + this.tabela + ".id" + ") " + "FROM "
	...
	public Boolean utilizando(String... keys) {
		...
		String sql = "SELECT " + "IF((" + "SELECT " + "MIN(" + this.banco + "." + this.tabela + ".id " + ") " + "FROM "
				+ this.banco + "." + this.tabela + " " + "WHERE " + this.banco + "." + this.tabela + "." + this.key
	...
	public O toDB(Z objeto) {
		...
		Class<? extends Object> c = objeto.getClass();
		Field[] ff = c.getDeclaredFields();

		O ob = toDB();
		Class<? extends Object> c2 = ob.getClass();
	...
	public Z fromDB(O objeto) {
		...
		z = fromDB();
		Class<? extends Object> c2 = z.getClass();
		Field[] atributos = c2.getDeclaredFields();
