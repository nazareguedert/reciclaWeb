...
public class Bairro {
	...
	public Bairro(Long id, String nome, Municipio municipio, Date dataInclusao, Date dataRemocao) {
		super();
		this.id = id;
		this.nome = nome;
		this.municipio = municipio;
	...
	public String toString() {
		return "Bairro [id=" + id + ", nome=" + nome + ", municipio=" + municipio + ", dataInclusao=" + dataInclusao
