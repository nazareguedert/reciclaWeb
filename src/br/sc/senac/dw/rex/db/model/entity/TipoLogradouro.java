...
public class TipoLogradouro {
	...
	public TipoLogradouro(Long id, String nome, Date dataInclusao, Date dataRemocao) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public String toString() {
		return "TipoLogradouro [id=" + id + ", nome=" + nome + ", dataInclusao=" + dataInclusao + ", dataRemocao="
				+ dataRemocao + "]";
	}
