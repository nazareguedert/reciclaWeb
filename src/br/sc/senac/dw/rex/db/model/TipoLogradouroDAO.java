...
public class TipoLogradouroDAO extends GenericDAO<TipoLogradouroDB, TipoLogradouro> {

	public TipoLogradouroDAO() {
		super(BaseDAO.BANCO[1], "tb_tipo_logradouro", "nome", new TipoLogradouroDB(), new TipoLogradouro());
	}

	@Override
	public TipoLogradouroDB toDB(TipoLogradouro i) {

		TipoLogradouroDB o = new TipoLogradouroDB();
	...
	@Override
	public TipoLogradouro fromDB(TipoLogradouroDB i) {

		TipoLogradouro o = new TipoLogradouro();
...
class TipoLogradouroDB {
	...
	public TipoLogradouroDB() {
		super();
	}

	public TipoLogradouroDB(Long id, String nome, Date data_inclusao, Date data_remocao) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoLogradouroDB other = (TipoLogradouroDB) obj;
	...
	public String toString() {
		return "TipoLogradouroDB [id=" + id + ", nome=" + nome + ", data_inclusao=" + data_inclusao + ", data_remocao="
				+ data_remocao + "]";
	}
