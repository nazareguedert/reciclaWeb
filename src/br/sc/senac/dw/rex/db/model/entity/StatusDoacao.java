...
public class StatusDoacao {
	...
	public StatusDoacao(String nome) {
		super();
		this.nome = nome;
	}

	public StatusDoacao(Long id, String nome, Date dataInclusao, Date dataRemocao) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StatusDoacao other = (StatusDoacao) obj;
	...
	public String toString() {
		return "StatusDoacao [id=" + id + ", nome=" + nome + ", dataInclusao="
